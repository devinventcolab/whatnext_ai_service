...
export const toolSchemas = {
  ...
  createWorklog: z
    .object({
      ...
      StartTime: z.string(),
      EndTime: z.string(),
      RealizationTime: z.coerce.number().optional(),
      Comment: z.string().optional(),
      taskId: z.union([z.string(), z.number()]).optional(),
      TaskID: z.union([z.string(), z.number()]).optional(),
      TaskName: z.string().optional(),
      TaskDetailsID: z.number().int().optional(),
      ProcessPhaseID: z.union([z.string(), z.number()]).optional(),
      ActivityID: z.union([z.string(), z.number()]).optional(),
      CompetenceID: z.union([z.string(), z.number()]).optional(),
      processPhases: z.string().optional(),
