...
const en: TranslationTable = {
  ...
  'field.task.dueDate.question': 'When is the due date?',
  ...
  'field.event.participants.question': 'Who should be participate?',
  ...
  'field.event.location.question': 'Where is it Location?',
