...
const envSchema = z.object({
  ...
  DOTNET_TASKS_UPDATE_PATH: z.string().optional(),
  DOTNET_NOTES_LIST_PATH: z.string().default('/user/NotesList'),
  DOTNET_NOTES_UPDATE_PATH: z.string().optional(),
  DOTNET_EVENTS_LIST_PATH: z.string().optional(),
  DOTNET_EVENTS_UPDATE_PATH: z.string().optional(),
